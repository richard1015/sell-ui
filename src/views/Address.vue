            ...
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex==index}"
                    @click="checkIndex=index;selectedAddressId=item.id">
                  <dl>
                    <dt>{{item.recName}}</dt>
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault"
                       @click="setDefault(item.id)"><i>Set default</i></a>
                  </div>
      ...
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <ul>
              <li class="regi_form_input"><input type="text" tabindex="1"
                                                 name="loginname"
                                                 v-model="userName"
          ...
          <div class="login-wrap"><a href="javascript:;" class="btn-login">保 存</a></div>
          <div class="login-wrap"><a href="javascript:;" class="btn-login">取 消</a></div>
        </div>
      </div>
    </div>
